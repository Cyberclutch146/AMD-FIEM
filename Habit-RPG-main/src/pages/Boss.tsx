        ...
        <div className="max-w-4xl mx-auto space-y-8 relative z-10 w-full">
          ...
          <div className="text-center space-y-2">
            <div className="flex items-center justify-center gap-2 mb-1">
              <span className="bg-amber-500/20 text-amber-500 text-[9px] border border-amber-500/20 px-3 py-1 rounded-full font-black uppercase tracking-widest">
                Risk Stage {currentBossIndex + 1} of {BOSS_ROSTER.length}
              </span>
              {defeatedCount > 0 && (
                <span className="bg-green-500/10 text-green-500 text-[9px] border border-green-500/30 px-3 py-1 rounded-full font-black uppercase tracking-widest">
                  {defeatedCount} Stages Cleared
                </span>
              )}
            </div>
            <span className="font-label text-sm tracking-[0.2em] text-amber-500 font-bold uppercase">Health Risk Assessment</span>
            ...
            <div className="flex items-center justify-center gap-2 text-neutral-500 font-label text-xs uppercase tracking-widest">
              ...
              PREVENTION: {currentBoss.weakness.toUpperCase()}
              <span className="material-symbols-outlined text-sm text-primary" style={{ fontVariationSettings: "'FILL' 1" }}>health_and_safety</span>
            </div>
          </div>
            ...
            <StarBorder speed="3s" color={currentBoss.themeColor} className="w-full">
              <div className="relative bg-surface-container-high rounded-xl overflow-hidden shadow-[0_0_60px_rgba(209,54,57,0.2)] w-full">
                <div className="aspect-[16/9] md:aspect-[21/9] relative">
                  ...
                  {/* HP badge */}
                  <div className="absolute top-4 left-4 bg-black/60 backdrop-blur-sm border border-amber-500/50 px-3 py-1.5 rounded-lg">
                    <p className="text-amber-400 text-[10px] font-black uppercase tracking-widest">Risk Level</p>
                  ...
                  {recentCrits.length > 0 && (
                    <div className="absolute top-4 right-4 bg-green-500/20 backdrop-blur-sm border border-green-500/50 px-3 py-1.5 rounded-lg">
                      <p className="text-green-400 text-[9px] font-black uppercase tracking-widest">🌟 Perfect Choices</p>
                ...
                <div className="p-6 md:p-8 space-y-6">
                  <div className="space-y-3">
                    <div className="flex justify-between items-end">
                      <div className="font-label text-xs tracking-widest text-secondary uppercase">RISK MITIGATED: {activeHp.toLocaleString()}/{currentBoss.maxHp.toLocaleString()}</div>
                  ...
                  <div className="h-4 w-full bg-surface-container-lowest rounded-full p-1 shadow-inner overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-amber-500 to-red-500 rounded-full relative transition-all duration-1000" style={{ width: `${100 - bossDamagePercent}%` }}>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="bg-surface-container-low p-4 rounded-xl border border-outline-variant/10 flex flex-col items-center justify-center text-center space-y-1 hover:bg-surface-container-high transition-colors shadow-lg">
              <span className="material-symbols-outlined text-green-500 text-3xl" style={{ fontVariationSettings: "'FILL' 1" }}>shield</span>
              <div className="text-xl font-black text-on-surface">{totalDamage.toLocaleString()}</div>
              <div className="font-label text-[9px] tracking-widest text-neutral-500 uppercase">Lifetime Protection</div>
            </div>
            <div className="bg-surface-container-low p-4 rounded-xl border border-outline-variant/10 flex flex-col items-center justify-center text-center space-y-1 hover:bg-surface-container-high transition-colors shadow-lg relative overflow-hidden">
              ...
              <div className="font-label text-[9px] tracking-widest text-neutral-500 uppercase">Current Threat</div>
            </div>
            <div className="bg-surface-container-low p-4 rounded-xl border border-outline-variant/10 flex flex-col items-center justify-center text-center space-y-1 hover:bg-surface-container-high transition-colors shadow-lg">
